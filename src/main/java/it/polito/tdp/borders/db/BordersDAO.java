...
//				Lo aggiungo alla mappa, utilizzano come key il codice
	...
	/**
	 * Restituisce una lista contenente tutti i confini, intesi come coppia di
	 * codici degli stati
	 * 
	 * @param anno
	 * @return
...
//			Aggiungo il parametro, ovvero l'anno a partire da cui voglio i confini
			...
			while (rs.next()) {
				...
				listaConfini
						.add(new Border(countryMap.get(rs.getInt("state1no")), countryMap.get(rs.getInt("state2no"))));
			}
